...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('particle_analyzer.py', '.'), ('i18n.py', '.')],
    ...
    excludes=[
        ...
        'dask', 'distributed', 'pyarrow', 'bokeh', 'xarray', 'narwhals',
        'xyzservices', 'onnxruntime', 'lxml', 'openpyxl', 'sympy',
        'skimage.viewer', 'skimage.io._plugins',
    ],
    noarchive=False,
    optimize=0,
)
